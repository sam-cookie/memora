  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-brand': 'linear-gradient(135deg, hsl(var(--brand-600)), hsl(var(--brand-400)))',
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': { boxShadow: '0 0 10px -2px hsl(var(--primary) / 0.2)' },
          '50%': { boxShadow: '0 0 25px -4px hsl(var(--primary) / 0.5)' },
        },
        shimmer: {
